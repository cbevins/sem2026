...
export function makeBackVector(fireEllipse, withFlameLength=true) {
    return makeBetaVector(fireEllipse, 180, withFlameLength)
}

export function makeHeadVector(fireEllipse, withFlameLength=true) {
    return makeBetaVector(fireEllipse, 0, withFlameLength)
}

export function makeLeftFlankVector(fireEllipse, withFlameLength=true) {
    const beta = calcBetaFromTheta(fireEllipse, 270)
    return makeBetaVector(fireEllipse, beta, withFlameLength)
}

export function makeRightFlankVector(fireEllipse, withFlameLength=true) {
