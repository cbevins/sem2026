...
function noFuelModelArg() { new FuelBed() }
function badFuelModelArg() { new FuelBed({fuelModel: {}}) }
...
describe('FuelBed Class', () => {
    ...
    it('throws an error if new FuelBed({fuelModel}) property is not a fuel model object', () => {
        expect(() => badFuelModelArg()).toThrow()
    })
