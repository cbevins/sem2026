...
// The fuel model catalog includes only those fuel models whose 'group' is TRUE.
export const CatalogModelGroups = {
...
export class StandardFuelModelCatalog {
    constructor(groups={}) {
        this.groups = {...CatalogModelGroups, ...groups}
        this.catalog = new Map()
        for(let model of StandardFuelModels) {
            if (this.groups[model.group]) {
