...
import { CuringConditionsTemplate } from "./CuringConditionsTemplate.js"

export class FuelBed {
    constructor(fuelModel, curingConditions={}, config={}) {
        this.config = {...ConfigTemplate, ...config}
        this.curingConditions = {...CuringConditionsTemplate, ...curingConditions}
    ...
    setFuelConditions(fuelModel, curingConditions={}) {
        ...
        this.curingConditions = {...this.curingConditions, ...curingConditions}
        this.modelCode = fuelModel.code     // just save the FuelModel.code

        this.depth = fuelModel.depth
        this.dead = new DeadFuelBed(fuelModel, this.curingConditions, this.config)
        this.live = new LiveFuelBed(fuelModel, this.curingConditions, this.config)
