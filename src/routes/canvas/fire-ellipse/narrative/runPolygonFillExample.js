...
import { polygonFill } from './polygonFill.js'
import { bresenham } from '../../bresenhamSuperCover.js'
...
// Demosntrate the bresenham() works across 3 quadrants
// let cells = bresenham(-10, -4, 10, 12)
// console.table(cells)
// console.table(bresenham(10,4, -10, -10))