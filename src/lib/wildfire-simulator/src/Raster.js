/**
 * A basic cols x rows Raster of 8-bit unsigned bytes
 * with a small suite of supporting access and drawing methods:
 * - get(col, row)
 * - set(col, row, value=1)
 * - fillCircle(centerCol, centerRow, r, value=1)
 * - fillEllipse(cx, cy, rx, ry, rotationDegrees, value=1)
 * - fillPolygon(points, value=1)
 * - fillRect(col, row, width, height, value=1)
 * - strokeCircle(cx, cy, radius, value=1)
 * - strokeEllipse(cx, cy, rx, ry, rotationDegrees, value=1, pad=0)
 * - strokeLine(x1, y1, x2, y2, value=1, cover=true)
