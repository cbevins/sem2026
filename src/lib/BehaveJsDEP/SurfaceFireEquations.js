export class SurfaceFireEquations {
    static arithmeticMeanSpreadRate (cover1, ros1, ros2) {
        return cover1 * ros1 + (1 - cover1) * ros2
    }

    static spreadRateFinal (apply, rosMax, rosLim) {
        return (apply.toLowerCase() === 'yes') ? rosLim : rosMax
    }
    ...
    static expectedValueSpreadRateMOCK (cover1, ros1, ros2) {
        return (
          0.5 *
     ...
     * @return The fireline intensity (btu+1 ft-1 s-1).
     */
    static firelineIntensityFromFlameLength (flame) {
    ...
    static harmonicMeanSpreadRate (cover1, ros1, ros2) {
      if (cover1 === 0 || ros1 === 0) {
        return ros2
      } else if (ros2 === 0) {
        return ros1
     ...
     */
    static maximumSpreadRate (ros0, phiEw) {
      return ros0 * (1 + phiEw)
    }
     ...
     * @return The maximum fire spread rate (ft+1 min-1).
     */
    static spreadRateWithCrossSlopeWind (ros0, spreadDirVectorRate) {
     ...
     * @param ews The effective wind speed limit (ft+1 min-1).
     * @return The maximum spread rate (ft+1 min-1) after applying any effective wind speed limit.
     */
    static spreadRateWithRosLimitApplied (rosMax, ews) {
     ...
     */
    static scorchHeight (fli, windSpeed, airTemp) {
     ...
     */
    static maximumDirectionSlopeSpreadRate (ros0, phiS) {
      return ros0 * phiS
    }
     ...
     */
    static maximumDirectionWindSpreadRate (ros0, phiW) {
      return ros0 * phiW
    }
     ...
     */
    static maximumDirectionSpreadRate (xComp, yComp) {
